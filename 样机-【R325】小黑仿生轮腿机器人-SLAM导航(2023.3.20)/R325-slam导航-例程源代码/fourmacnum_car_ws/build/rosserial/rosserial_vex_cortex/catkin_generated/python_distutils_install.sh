...
echo_and_run cd "/home/ubuntu/fourmacnum_car_ws/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/fourmacnum_car_ws/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/ubuntu/fourmacnum_car_ws/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
