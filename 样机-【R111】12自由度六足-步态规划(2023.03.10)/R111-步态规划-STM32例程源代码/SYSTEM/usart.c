...
u8 USART_TX_BUF[USART_REC_LEN]; 	//发送缓冲,最大USART3_MAX_SEND_LEN字节
u8 USART_RX_BUF[USART_REC_LEN]; 				//接收缓冲,最大USART3_MAX_RECV_LEN个字节.
...
void usart_send(unsigned char c)//发送单一字符
{
