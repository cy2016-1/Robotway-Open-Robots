...
void TSC_WB(int Level0, int Level1)     
{
  ...
  Timer1.attachInterrupt(TSC_Callback).start(100000);
}
//初始化
void setup()
{
  ...
  Timer1.attachInterrupt(TSC_Callback).start(1000000);
...
void loop()
{
    ...
    SerialUSB.println((String)(color[0]) + '+' + (String)(color[1]) + '+' + (String)(color[2]) + '+');
}
#endif